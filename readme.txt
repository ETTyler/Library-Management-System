...
- However, I decided against this approach and instead separated it into reusable database interactions with individual main functions to perform the tasks.
